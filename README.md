...
A simple repository template to start coding from scratch
...
```shell
docker pull nexus.mia-platform.eu/hcp-terraform/tf-demo-python-hello-world:latest
set -a
source .env
docker run --name tf-demo-python-hello-world \
  --detach \
  nexus.mia-platform.eu/hcp-terraform/tf-demo-python-hello-world
```

[merge-request]: https://github.com/Mia-Platform-Experiments/tf-demo-python-hello-world/merge_requests
